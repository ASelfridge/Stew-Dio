...
let ntw_bowl = {id:'bowl', position:{x:-5.49, y:1.9, z:-6.25}, rotation:{x:0, y:0, z:0}};
let ntw_onion = {id:"onion", position:{x: 3.792, y:1.974, z:7.898}, rotation:{x:0, y:0, z:0}};
let ntw_squash = {id:"squash", position:{x: 4.3, y:1.97431, z:7.4}, rotation:{x:0, y:0, z:0}};
let ntw_garlic = {id:"garlic", position:{x: 4.911 , y:1.930 , z:6.557}, rotation:{x:0, y:0, z:0}};
let ntw_mushroom = {id:"mushroom", position:{x: 5.484 , y:1.935 , z:5.555}, rotation:{x:0, y:0, z:0}};
let ntw_potato = {id:"potato", position:{x: 6.402 , y:2.004 , z:4.746}, rotation:{x:0, y:0, z:0}};
let ntw_corn = {id:"corn", position:{x: 6.422 , y:2.002 , z:4.039}, rotation:{x:0, y:0, z:0}};
let ntw_carrot = {id:"carrot", position:{x: 6.860 , y:1.994 , z:3.274}, rotation:{x:0, y:0, z:0}};
let ntw_celery = {id:"celery", position:{x: 7.551 , y:2.006 , z:2.499}, rotation:{x:0, y:0, z:0}};
let ntw_blackBeans = {id:"blackBeans", position:{x: 8.073 , y:1.912 , z:2.127}, rotation:{x:0, y:0, z:0}};
let ntw_lentils = {id:"lentils", position:{x: 8.544 , y:1.964 , z:1.442}, rotation:{x:0, y:0, z:0}};
let ntw_pasta = {id:"pasta", position:{x: 3.530 , y:1.936 , z:8.752}, rotation:{x:0, y:0, z:0}};
let ntw_chicken = {id:"chicken", position:{x: 9.226 , y:1.984 , z:0.768}, rotation:{x:0, y:0, z:0}};
